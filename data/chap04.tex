...
上述问题是从原子并行模型中所有点到真实GPU可以执行的CUDA代码所共有的。下面以RB+PR+RM和EB+PR+RM为例介绍部署的细节。如~\ref{sec:spacedef}中所述，RB+PR+RM在原子并行中表示为$\{<\frac{1}{g}\,row, c\,col>,r\}$，
