...
\begin{abstract}
  ...
  基于扩展后的优化空间，本文将灵活规约纳入稀疏迭代模型，并提出灵活规约语义提升技术，该技术使得用户可以通过简单调度指令针对任意稀疏稠密混合代数进行灵活规约扩展优化空间的性能调优。该技术将原有稀疏算子编译器生成的稀疏稠密矩阵向量乘算子性能平均提升1.2倍，最多提升3.8倍；矩阵化张量乘Khatri-Rao积算子最高提升2.7倍。
